...
const tutorialRoutes = [
  { path: "/tutorials/sorting/introduction", title: "Introduction to Sort" },
  { path: "/tutorials/sorting/selection-sort", title: "Selection Sort" },
  { path: "/tutorials/sorting/insertion-sort", title: "Insertion Sort" },
  { path: "/tutorials/sorting/heap-sort", title: "Heap Sort" },
  { path: "/tutorials/sorting/merge-sort", title: "Merge Sort" },
  { path: "/tutorials/sorting/applications", title: "Sorting Applications" },
  { path: "/tutorials/sorting/best-practices", title: "Best Practice" },
]
        ...
        >
          ...
          <nav className="p-4">
            <div className="flex items-center mb-4 text-white">
              ...
              <p className="text-sm font-semibold uppercase tracking-wider text-white/50">Sorting Tutorials</p>
            </div>
