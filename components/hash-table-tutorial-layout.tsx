...
import { ArrowLeft, ArrowRight, Home, Menu, X, Hash, Linkedin, Github } from "lucide-react"
...
const tutorialRoutes = [
  { path: "/tutorials/hash-table/introduction", title: "Introduction to Hash Tables" },
  { path: "/tutorials/hash-table/insert-operation", title: "Insert Operation" },
  { path: "/tutorials/hash-table/delete-operation", title: "Delete Operation" },
  { path: "/tutorials/hash-table/search-operation", title: "Search Operation" },
  { path: "/tutorials/hash-table/applications", title: "Applications of Hash Tables" },
]

export function HashTableTutorialLayout({
  children,
  title,
  description,
  currentStep,
        ...
        >
          ...
          <nav className="p-4">
            <div className="flex items-center mb-4 text-white">
              ...
              <p className="text-sm font-semibold uppercase tracking-wider text-white/50">Hash Table Tutorials</p>
            </div>
