...
import { ArrowLeft, ArrowRight, Home, Menu, X, Layers, Linkedin, Github } from "lucide-react"
...
const tutorialRoutes = [
  { path: "/tutorials/stack/introduction", title: "Introduction to Stacks" },
  { path: "/tutorials/stack/push-operation", title: "Push Operation" },
  { path: "/tutorials/stack/pop-operation", title: "Pop Operation" },
  { path: "/tutorials/stack/peek-operation", title: "Peek Operation" },
  { path: "/tutorials/stack/applications", title: "Applications of Stacks" },
]

export function StackTutorialLayout({
  children,
  title,
  description,
  currentStep,
        ...
        >
          ...
          <nav className="p-4">
            <div className="flex items-center mb-4 text-white">
              ...
              <p className="text-sm font-semibold uppercase tracking-wider text-white/50">Stack Tutorials</p>
            </div>
