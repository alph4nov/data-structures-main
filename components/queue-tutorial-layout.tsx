...
import { ArrowLeft, ArrowRight, Home, Menu, X, AlignJustify, Linkedin, Github } from "lucide-react"
...
const tutorialRoutes = [
  { path: "/tutorials/queue/introduction", title: "Introduction to Queues" },
  { path: "/tutorials/queue/enqueue-operation", title: "Enqueue Operation" },
  { path: "/tutorials/queue/dequeue-operation", title: "Dequeue Operation" },
  { path: "/tutorials/queue/peek-operation", title: "Peek Operation" },
  { path: "/tutorials/queue/applications", title: "Applications of Queues" },
]

export function QueueTutorialLayout({
  children,
  title,
  description,
  currentStep,
        ...
        >
          ...
          <nav className="p-4">
            <div className="flex items-center mb-4 text-white">
              <AlignJustify className="h-5 w-5 mr-2 text-purple-400" />
              <p className="text-sm font-semibold uppercase tracking-wider text-white/50">Queue Tutorials</p>
            </div>
